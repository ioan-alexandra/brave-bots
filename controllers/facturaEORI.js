...
function populateFactura(info, sms) {
    ...
    if (info.persFizica == "NU") {
        ...
        request.open(
            "GET",
            `https://api.openapi.ro/api/companies/${info.cuiFactura}`
        );

        request.setRequestHeader(
            "x-api-key",
            "dqufAMwAz9h6KqkpdzxQn3ZnYSGuyYEy_CKdB1DS-eNxey_bQQ"
        );
        request.onreadystatechange = function () {
            if (this.readyState === 4) {
                ...
                let adresa = obj.adresa + ", " + obj.judet;
                    ...
                    "linii": [
                      {
                         ...
                         "pers_fizica": "0",
                         "denumire": ${JSON.stringify(obj.denumire)},
...
function importPartener(data) {
    ...
    xhr.setRequestHeader(
        "Authorization",
        "Basic QjQxNUMzNUNENzIxNDBDNkI4OEUzODFERjJERjcxRkY6"
    );
